...
function GetHistoriquePaiement() {
    ...
    useEffect(()=>{
      ...
      axios({
        method:"get",
        url:`http://localhost:8500/paiement/?month=${sendMonth}&year=${sendYear}`,
        responseType: 'json',
        headers: {
            'Authorization': token,
    ...
    return (
        <>
          ...
          <div className="card-box mb-30">
						<div className="pd-20">
							<h4 className="h4">Historique des paiements</h4>
						</div>
						<div className="pb-20">
  ...
  export default GetHistoriquePaiement;